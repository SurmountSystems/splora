...
- L1 main session
  ...
  - L2 Delta inventory 154 and max_txs
    - L3 specialists (when spawned)
  - L2 Draft FORK README residual
    - L3 specialists (when spawned)
  - L2 Draft appliance Nix files
    - L3 specialists (when spawned)
  - L2 Draft crane splora-http flake
    - L3 specialists (when spawned)
  - L2 Draft packaging test update
    - L3 specialists (when spawned)
  - L2 Draft secp residual report
    - L3 specialists (when spawned)
  - L2 Draft splora-http systemd unit
    - L3 specialists (when spawned)
  - L2 Drop signetblocktime from Core
    - L3 specialists (when spawned)
  - L2 Dual residual honesty PR ports
    - L3 specialists (when spawned)
  - L2 Electrum join shutdown order
    - L3 specialists (when spawned)
  ...
  - L2 HTTP front coordinator
    - L3 specialists (when spawned)
  - L2 Hyper 1 and secp proof
    - L3 specialists (when spawned)
  - L2 Implement memory flush 6a-6d
    - L3 specialists (when spawned)
  - L2 Implement memory snapshot
    - L3 specialists (when spawned)
  - L2 Implement splora-http front
    - L3 specialists (when spawned)
  - L2 In-tree Nix node wiring
    - L3 specialists (when spawned)
  - L2 In-tree nixpkgs node pins
    - L3 specialists (when spawned)
  - L2 Inspect Electrum join shutdown
    - L3 specialists (when spawned)
  - L2 Inspect Liquid peg-in sigops
    - L3 specialists (when spawned)
  - L2 Inspect Mempool PR contracts
    - L3 specialists (when spawned)
  - L2 Inspect Mutinynet bitcoind slice
    - L3 specialists (when spawned)
  - L2 Inspect http_front implementer diffs
    - L3 specialists (when spawned)
  - L2 Inspect residual honesty after fix
    - L3 specialists (when spawned)
  - L2 Inventory PR port reports
    - L3 specialists (when spawned)
  ...
  - L2 MWCK reorg replay TDD
    - L3 specialists (when spawned)
  - L2 Map HTTP front and mempool paths
    - L3 specialists (when spawned)
  - L2 Map NixOS node inventory
    - L3 specialists (when spawned)
  - L2 Map RocksDB LRU leftover
    - L3 specialists (when spawned)
  ...
  - L2 Memory snapshot briefing
    - L3 specialists (when spawned)
  - L2 Mempool eviction body cache
    - L3 specialists (when spawned)
  - L2 Menhera cargo lock update
    - L3 specialists (when spawned)
  - L2 Menhera cargo update
    - L3 specialists (when spawned)
  ...
  - L2 Port splora to hyper 1
    - L3 specialists (when spawned)
  - L2 Primary source node releases
    - L3 specialists (when spawned)
  - L2 Prove bitcoind NEEDED libsecp256k1
    - L3 specialists (when spawned)
  - L2 RESIDUAL.md dual honesty
    - L3 specialists (when spawned)
  - L2 RESIDUAL.md dual honesty
    - L3 specialists (when spawned)
  - L2 Re-inspect Mutinynet argv fix
    - L3 specialists (when spawned)
  - L2 Re-read residual peg-in pin
    - L3 specialists (when spawned)
  ...
  - L2 Record remote tests then test-remote
    - L3 specialists (when spawned)
  - L2 Remote check after hyper 1
    - L3 specialists (when spawned)
  - L2 Remote check then all tests
    - L3 specialists (when spawned)
  - L2 Remote flake check nextest
    - L3 specialists (when spawned)
  - L2 Residual HTTP front paths
    - L3 specialists (when spawned)
  - L2 Residual after green remote
    - L3 specialists (when spawned)
  - L2 Residual honesty after audit
    - L3 specialists (when spawned)
  - L2 Residual honesty for 1.98.1
    - L3 specialists (when spawned)
  - L2 Residual honesty review
    - L3 specialists (when spawned)
  - L2 Review 1.98.1 pin and audit
    - L3 specialists (when spawned)
  - L2 Review claimed Nix leftover
    - L3 specialists (when spawned)
  - L2 Review splora-http front
    - L3 specialists (when spawned)
  - L2 Rewrite Mempool PR decision log
    - L3 specialists (when spawned)
  - L2 Run and fix check-local
    - L3 specialists (when spawned)
  ...
  - L2 Snapshot implementer memory
    - L3 specialists (when spawned)
  - L2 Status of flake residual
    - L3 specialists (when spawned)
  - L2 System secp256k1 leveldb
    - L3 specialists (when spawned)
  - L2 TDD broadcast maxfeerate 84
    - L3 specialists (when spawned)
  - L2 TDD clamp unbounded max_txs
    - L3 specialists (when spawned)
  - L2 TDD history-row cap 145
    - L3 specialists (when spawned)
  - L2 TDD shutdown watchdog 154
    - L3 specialists (when spawned)
  - L2 Toolchain pin to 1.98.1
    - L3 specialists (when spawned)
  - L2 Trash grok-1000 implement files
    - L3 specialists (when spawned)
  - L2 Trash grok-1000 implement files
    - L3 specialists (when spawned)
  - L2 Trash implement artifacts fc86c96d
    - L3 specialists (when spawned)
  - L2 Trash implement grok files
    - L3 specialists (when spawned)
  - L2 Untracked flake residual verify
    - L3 specialists (when spawned)
  - L2 Update implement memory file
    - L3 specialists (when spawned)
  ...
  - L2 Wait cargo-update report
    - L3 specialists (when spawned)
  - L2 Wait or recover audit
    - L3 specialists (when spawned)
  - L2 Wait then splora check-remote
    - L3 specialists (when spawned)
  - L2 Wire Gentoo secp CMake
    - L3 specialists (when spawned)
  ...
  - L2 [cleanup] Trash implement scratch
    - L3 specialists (when spawned)
  - L2 [implementer] Auth queue NIP-98
    - L3 specialists (when spawned)
  - L2 [implementer] Blockstream cherry-picks
    - L3 specialists (when spawned)
  - L2 [implementer] Cap NIP-98 header size
    - L3 specialists (when spawned)
  - L2 [implementer] Clap 4 drop atty
    - L3 specialists (when spawned)
  - L2 [implementer] Confirm 503 tests compile
    - L3 specialists (when spawned)
  - L2 [implementer] Confirm operator-gated gate
    - L3 specialists (when spawned)
  - L2 [implementer] Crane skip Menhera
    - L3 specialists (when spawned)
  - L2 [implementer] Crane src for include_str
    - L3 specialists (when spawned)
  - L2 [implementer] Electrum join shutdown
    - L3 specialists (when spawned)
  - L2 [implementer] Evicted mempool bodies
    - L3 specialists (when spawned)
  - L2 [implementer] Fix help flag test
    - L3 specialists (when spawned)
  - L2 [implementer] Fix leftover compile
    - L3 specialists (when spawned)
  - L2 [implementer] Fix leftover review
    - L3 specialists (when spawned)
  - L2 [implementer] Fix nostr wincode compile
    - L3 specialists (when spawned)
  - L2 [implementer] Fix queue write path
    - L3 specialists (when spawned)
  - L2 [implementer] Fix remaining clippy
    - L3 specialists (when spawned)
  ...
  - L2 [implementer] Liquid pegin sigops
    - L3 specialists (when spawned)
  - L2 [implementer] Live allowlist watch test
    - L3 specialists (when spawned)
  - L2 [implementer] MWCK notify polish
    - L3 specialists (when spawned)
  - L2 [implementer] MWCK reorg replay
    - L3 specialists (when spawned)
  ...
  - L2 [implementer] NixOS module docs
    - L3 specialists (when spawned)
  - L2 [implementer] Prove remaining residual
    - L3 specialists (when spawned)
  - L2 [implementer] Queue CSV two-file
    - L3 specialists (when spawned)
  - L2 [implementer] REST 503 504
    - L3 specialists (when spawned)
  - L2 [implementer] Re-prove operator-gated residual
    - L3 specialists (when spawned)
  - L2 [implementer] Remaining appliance residual
    - L3 specialists (when spawned)
  - L2 [implementer] Remaining audit warnings
    - L3 specialists (when spawned)
  - L2 [implementer] Remote JSON-RPC module
    - L3 specialists (when spawned)
  - L2 [implementer] Residual after 1 and 2
    - L3 specialists (when spawned)
  - L2 [implementer] Residual after audit
    - L3 specialists (when spawned)
  - L2 [implementer] Residual polish honesty
    - L3 specialists (when spawned)
  - L2 [implementer] Rust 1.98 RocksDB flake
    - L3 specialists (when spawned)
  - L2 [implementer] Skip table docs
    - L3 specialists (when spawned)
  - L2 [implementer] Sockets docs timer
    - L3 specialists (when spawned)
  - L2 [implementer] Supply chain flake
    - L3 specialists (when spawned)
  - L2 [implementer] TDD Mempool PR ports
    - L3 specialists (when spawned)
  - L2 [implementer] Update crates and audit
    - L3 specialists (when spawned)
  - L2 [implementer] Update residual honesty
    - L3 specialists (when spawned)
  - L2 [implementer] Verify operator-gated residual
    - L3 specialists (when spawned)
  - L2 [implementer] WS 101 RocksDB proof
    - L3 specialists (when spawned)
  - L2 [implementer] Wire HTTP auth WS
    - L3 specialists (when spawned)
  - L2 [implementer] Write FORK.md
    - L3 specialists (when spawned)
  - L2 [implementer] Write residual file
    - L3 specialists (when spawned)
  - L2 [implementer] cargo-deny hygiene
    - L3 specialists (when spawned)
  - L2 [implementer] check-local then remote
    - L3 specialists (when spawned)
  - L2 [implementer] finish Electrum shutdown
    - L3 specialists (when spawned)
  ...
  - L2 [implementer] residual peg-in placement
    - L3 specialists (when spawned)
  - L2 [implementer] update audit check-remote
    - L3 specialists (when spawned)
  - L2 [implementer] wait TDD ports then remote
    - L3 specialists (when spawned)
  - L2 [implementer] wait audit remote residual
    - L3 specialists (when spawned)
  - L2 [memory] Flush review patterns
    - L3 specialists (when spawned)
  - L2 [memory] Flush review patterns
    - L3 specialists (when spawned)
  - L2 [memory] Flush review patterns
  ...
  - L2 [memory] Flush review patterns
    - L3 specialists (when spawned)
  - L2 [memory] Snapshot past issues
    - L3 specialists (when spawned)
  - L2 [memory] Snapshot past issues
    - L3 specialists (when spawned)
  - L2 [memory] Snapshot past issues
  ...
  - L2 [memory] Snapshot past issues
    - L3 specialists (when spawned)
  - L2 [reviewer] Mempool PR port review
    - L3 specialists (when spawned)
  - L2 [reviewer] Re-review fixes
    - L3 specialists (when spawned)
  - L2 [reviewer] Re-review fixes
    - L3 specialists (when spawned)
  - L2 [reviewer] Re-review fixes
  ...
  - L2 [reviewer] Re-review fixes
    - L3 specialists (when spawned)
  - L2 [reviewer] Re-review header cap
    - L3 specialists (when spawned)
  - L2 [reviewer] Re-review leftover fixes
    - L3 specialists (when spawned)
  - L2 [reviewer] Re-review queue dir
    - L3 specialists (when spawned)
  - L2 [reviewer] Review clap hyper audit
    - L3 specialists (when spawned)
  - L2 [reviewer] Review crate update
    - L3 specialists (when spawned)
  - L2 [reviewer] Review implementation
    - L3 specialists (when spawned)
  - L2 [reviewer] Review implementation
    - L3 specialists (when spawned)
  - L2 [reviewer] Review implementation
  ...
  - L2 agent-trash tagged grok files
    - L3 specialists (when spawned)
  - L2 cargo audit and deny
    - L3 specialists (when spawned)
  - L2 combined impl summary residual retry
    - L3 specialists (when spawned)
  - L2 fix residual honesty and review
    - L3 specialists (when spawned)
  - L2 goal plan writer
    - L3 specialists (when spawned)
  - L2 goal plan writer
  ...
  - L2 goal plan writer
    - L3 specialists (when spawned)
  - L2 http_front named tests
    - L3 specialists (when spawned)
  - L2 http_front tests and residual
    - L3 specialists (when spawned)
  - L2 just check-remote flake
    - L3 specialists (when spawned)
  - L2 nix-bitcoin primary source status
    - L3 specialists (when spawned)
  - L2 nixosTenUnits and package evals
    - L3 specialists (when spawned)
  - L2 nixpkgs bitcoind elementsd versions
    - L3 specialists (when spawned)
  - L2 retry residual then mark review fixed
    - L3 specialists (when spawned)
  - L2 wait then residual honesty retry
    - L3 specialists (when spawned)
...
| Draft crane splora-http flake | nested L2 session usage | L2 | 58479 | estimate | exited |
| Draft packaging test update | nested L2 session usage | L2 | 55264 | estimate | exited |
| Draft secp residual report | nested L2 session usage | L2 | 73601 | estimate | exited |
...
| Implement memory flush 6a-6d | nested L2 session usage | L2 | 66834 | estimate | exited |
| Implement memory snapshot | nested L2 session usage | L2 | 57634 | estimate | exited |
| Implement splora-http front | nested L2 session usage | L2 | 162640 | estimate | exited |
| In-tree Nix node wiring | nested L2 session usage | L2 | 63951 | estimate | exited |
| In-tree nixpkgs node pins | nested L2 session usage | L2 | 55610 | estimate | exited |
| Inspect Electrum join shutdown | nested L2 session usage | L2 | 78320 | estimate | exited |
| Inspect Liquid peg-in sigops | nested L2 session usage | L2 | 108959 | estimate | exited |
| Inspect Mempool PR contracts | nested L2 session usage | L2 | 124917 | estimate | exited |
| Inspect Mutinynet bitcoind slice | nested L2 session usage | L2 | 102462 | estimate | exited |
| Inspect http_front implementer diffs | nested L2 session usage | L2 | 71333 | estimate | exited |
...
| Mempool eviction body cache | nested L2 session usage | L2 | 99048 | estimate | exited |
...
| RESIDUAL.md dual honesty | nested L2 session usage | L2 | 69824 | estimate | exited |
| RESIDUAL.md dual honesty | nested L2 session usage | L2 | 69557 | estimate | exited |
| Re-inspect Mutinynet argv fix | nested L2 session usage | L2 | 72053 | estimate | exited |
...
| Remote flake check nextest | nested L2 session usage | L2 | 58907 | estimate | exited |
| Residual HTTP front paths | nested L2 session usage | L2 | 64234 | estimate | exited |
| Residual after green remote | nested L2 session usage | L2 | 70930 | estimate | exited |
| Residual honesty after audit | nested L2 session usage | L2 | 95718 | estimate | exited |
| Residual honesty for 1.98.1 | nested L2 session usage | L2 | 109615 | estimate | exited |
| Residual honesty review | nested L2 session usage | L2 | 84924 | estimate | exited |
| Review 1.98.1 pin and audit | nested L2 session usage | L2 | 86936 | estimate | exited |
| Review claimed Nix leftover | nested L2 session usage | L2 | 85424 | estimate | exited |
| Review splora-http front | nested L2 session usage | L2 | 85330 | estimate | exited |
...
| TDD broadcast maxfeerate 84 | nested L2 session usage | L2 | 66617 | estimate | exited |
| TDD clamp unbounded max_txs | nested L2 session usage | L2 | 128523 | estimate | exited |
| TDD history-row cap 145 | nested L2 session usage | L2 | 92682 | estimate | exited |
| TDD shutdown watchdog 154 | nested L2 session usage | L2 | 83409 | estimate | exited |
| Toolchain pin to 1.98.1 | nested L2 session usage | L2 | 89953 | estimate | exited |
| Trash grok-1000 implement files | nested L2 session usage | L2 | 40779 | estimate | exited |
| Trash grok-1000 implement files | nested L2 session usage | L2 | 48269 | estimate | exited |
| Trash implement artifacts fc86c96d | nested L2 session usage | L2 | 43558 | estimate | exited |
| Trash implement grok files | nested L2 session usage | L2 | 52931 | estimate | exited |
...
| [cleanup] Trash implement scratch | nested L2 session usage | L2 | 43117 | estimate | exited |
| [cleanup] Trash implement scratch | nested L2 session usage | L2 | 43982 | estimate | exited |
| [implementer] Auth queue NIP-98 | nested L2 session usage | L2 | 178674 | estimate | exited |
| [implementer] Blockstream cherry-picks | nested L2 session usage | L2 | 190725 | estimate | exited |
| [implementer] Cap NIP-98 header size | nested L2 session usage | L2 | 78004 | estimate | exited |
| [implementer] Clap 4 drop atty | nested L2 session usage | L2 | 149855 | estimate | exited |
| [implementer] Confirm 503 tests compile | nested L2 session usage | L2 | 42582 | estimate | exited |
| [implementer] Confirm operator-gated gate | nested L2 session usage | L2 | 43918 | estimate | exited |
| [implementer] Crane skip Menhera | nested L2 session usage | L2 | 75840 | estimate | exited |
| [implementer] Crane src for include_str | nested L2 session usage | L2 | 96998 | estimate | exited |
| [implementer] Electrum join shutdown | nested L2 session usage | L2 | 54203 | estimate | exited |
| [implementer] Evicted mempool bodies | nested L2 session usage | L2 | 44336 | estimate | exited |
| [implementer] Fix help flag test | nested L2 session usage | L2 | 52903 | estimate | exited |
| [implementer] Fix leftover compile | nested L2 session usage | L2 | 92069 | estimate | exited |
| [implementer] Fix leftover review | nested L2 session usage | L2 | 131721 | estimate | exited |
| [implementer] Fix nostr wincode compile | nested L2 session usage | L2 | 122493 | estimate | exited |
| [implementer] Fix queue write path | nested L2 session usage | L2 | 143103 | estimate | exited |
| [implementer] Fix remaining clippy | nested L2 session usage | L2 | 83151 | estimate | exited |
| [implementer] Fix review issues | nested L2 session usage | L2 | 130523 | estimate | exited |
...
| [implementer] REST 503 504 | nested L2 session usage | L2 | 118433 | estimate | exited |
| [implementer] Re-prove operator-gated residual | nested L2 session usage | L2 | 46859 | estimate | exited |
| [implementer] Remaining appliance residual | nested L2 session usage | L2 | 68609 | estimate | exited |
| [implementer] Remaining audit warnings | nested L2 session usage | L2 | 248664 | estimate | exited |
| [implementer] Remote JSON-RPC module | nested L2 session usage | L2 | 92217 | estimate | exited |
| [implementer] Residual after 1 and 2 | nested L2 session usage | L2 | 51201 | estimate | exited |
| [implementer] Residual after audit | nested L2 session usage | L2 | 54312 | estimate | exited |
| [implementer] Residual polish honesty | nested L2 session usage | L2 | 56872 | estimate | exited |
| [implementer] Rust 1.98 RocksDB flake | nested L2 session usage | L2 | 174290 | estimate | exited |
...
| [implementer] WS 101 RocksDB proof | nested L2 session usage | L2 | 104969 | estimate | exited |
| [implementer] Wire HTTP auth WS | nested L2 session usage | L2 | 148356 | estimate | exited |
...
| [memory] Flush review patterns | nested L2 session usage | L2 | 47218 | estimate | exited |
| [memory] Flush review patterns | nested L2 session usage | L2 | 44319 | estimate | exited |
| [memory] Flush review patterns | nested L2 session usage | L2 | 57706 | estimate | exited |
| [memory] Flush review patterns | nested L2 session usage | L2 | 42953 | estimate | exited |
| [memory] Snapshot past issues | nested L2 session usage | L2 | 42537 | estimate | exited |
| [memory] Snapshot past issues | nested L2 session usage | L2 | 41939 | estimate | exited |
...
| [reviewer] Re-review fixes | nested L2 session usage | L2 | 48968 | estimate | exited |
| [reviewer] Re-review header cap | nested L2 session usage | L2 | 99812 | estimate | exited |
| [reviewer] Re-review leftover fixes | nested L2 session usage | L2 | 135454 | estimate | exited |
| [reviewer] Re-review queue dir | nested L2 session usage | L2 | 146191 | estimate | exited |
| [reviewer] Review clap hyper audit | nested L2 session usage | L2 | 110989 | estimate | exited |
| [reviewer] Review crate update | nested L2 session usage | L2 | 83786 | estimate | exited |
| [reviewer] Review implementation | nested L2 session usage | L2 | 113982 | estimate | exited |
| [reviewer] Review implementation | nested L2 session usage | L2 | 50131 | estimate | exited |
| [reviewer] Review implementation | nested L2 session usage | L2 | 55534 | estimate | exited |
| [reviewer] Review implementation | nested L2 session usage | L2 | 44815 | estimate | exited |
...
| fix residual honesty and review | nested L2 session usage | L2 | 69322 | estimate | exited |
| goal plan writer | nested L2 session usage | L2 | 96300 | estimate | exited |
| goal plan writer | nested L2 session usage | L2 | 97294 | estimate | exited |
| goal plan writer | nested L2 session usage | L2 | 98597 | estimate | exited |
| goal plan writer | nested L2 session usage | L2 | 94661 | estimate | exited |
| goal plan writer | nested L2 session usage | L2 | 98713 | estimate | exited |
| goal plan writer | nested L2 session usage | L2 | 228827 | estimate | exited |
| goal plan writer | nested L2 session usage | L2 | 228827 | estimate | exited |
| goal plan writer | nested L2 session usage | L2 | 228827 | estimate | exited |
| goal plan writer | nested L2 session usage | L2 | 228827 | estimate | exited |
| goal plan writer | nested L2 session usage | L2 | 228827 | estimate | exited |
| http_front named tests | nested L2 session usage | L2 | 157674 | estimate | exited |
| http_front tests and residual | nested L2 session usage | L2 | 131440 | estimate | exited |
| just check-remote flake | nested L2 session usage | L2 | 68968 | estimate | exited |
| nix-bitcoin primary source status | nested L2 session usage | L2 | 156061 | estimate | exited |
| nixosTenUnits and package evals | nested L2 session usage | L2 | 63855 | estimate | exited |
| nixpkgs bitcoind elementsd versions | nested L2 session usage | L2 | 75136 | estimate | exited |
| retry residual then mark review fixed | nested L2 session usage | L2 | 63323 | estimate | exited |
| wait then residual honesty retry | nested L2 session usage | L2 | 66422 | estimate | exited |
